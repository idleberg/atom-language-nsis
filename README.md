...
Install `language-nsis` from the [Package Manager](http://flight-manual.atom.io/using-atom/sections/atom-packages/) or using the command-line `apm install language-nsis`
