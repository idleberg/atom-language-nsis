...
Install `language-nsis` from the [Package Manager](http://flight-manual.atom.io/using-atom/sections/atom-packages/) or by using the command-line equivalent `apm install language-nsis`
