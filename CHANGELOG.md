...
# v11.3.5 [#](https://github.com/idleberg/atom-language-nsis/releases/tag/v11.3.5)

- update formatting library

# v11.3.4 [#](https://github.com/idleberg/atom-language-nsis/releases/tag/v11.3.4)

- update dependencies

# v11.3.3 [#](https://github.com/idleberg/atom-language-nsis/releases/tag/v11.3.3)

- fix positional highlighting issue in definitions
- update dependencies

# v11.3.2 [#](https://github.com/idleberg/atom-language-nsis/releases/tag/v11.3.2)

- update dependencies

# v11.3.1 [#](https://github.com/idleberg/atom-language-nsis/releases/tag/v11.3.1)
...
# v11.2.2 [#](https://github.com/idleberg/atom-language-nsis/releases/tag/v11.2.2)
