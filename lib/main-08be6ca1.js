        ...
        return __generator$2(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-c0663a58.js'); }).then(function (n) { return n.index; })];
                case 1:
...
function openURL(nsisCommand) {
    return __awaiter$2(this, void 0, void 0, function () {
        ...
        return __generator$2(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-adf799f6.js'); }).then(function (n) { return n.index; })];
                case 1:
        ...
        return __generator$2(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-ce799664.js'); }).then(function (n) { return n.index; })];
                case 2:
    ...
    return __awaiter$2(this, void 0, void 0, function () {
        ...
        return __generator$2(this, function (_g) {
            switch (_g.label) {
                ...
                case 9:
                    NSIS = _g.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./callbacks-5bfce6df.js'); })];
                case 10:
...
var commandReference = {
    init: function () {
        return __awaiter$2(this, void 0, void 0, function () {
            ...
            return __generator$2(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./select-list-view-8e3d67f3.js'); }).then(function (n) { return n.selectListView; })];
                    case 1:
                                ...
                                return __generator$2(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, Promise.resolve().then(function () { return require('./build-7929b12d.js'); })];
                                        case 2:
                                ...
                                return __generator$2(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, Promise.resolve().then(function () { return require('./runner-126e2906.js'); })];
                                        case 2:
...
exports.main = main;
exports.util = util;
//# sourceMappingURL=main-08be6ca1.js.map
