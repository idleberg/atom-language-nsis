...
var b=codepages().map(e=>`CP${e}`),O=["ACP",...b,"OEM","UTF8","UTF16BE","UTF16LE"],E=["ACP",...b,"OEM","UTF16BE","UTF16BEBOM","UTF16LE","UTF16LEBOM","UTF8","UTF8SIG"];function x(e){if(e.includes('Output: "')){let n=new RegExp('Output: "(.*.exe)"',"g").exec(e.toString());if(typeof n=="object"&&n&&n[1])try{return n[1]}catch{return null}}return null}function I(e,t,n){let s=e.stdout.toString().trim(),o=e.stderr.toString().trim(),i={stdout:s,stderr:o};if(t.includes("-CMDHELP")&&!s.trim()&&o&&([i.stdout,i.stderr]=[o,""]),n.json===!0)if(t.includes("-CMDHELP")){let r=n.wine===!0?2:1;t.length===r?i.stdout=v(s,n):i.stdout=g(s,"help");}else t.includes("-HDRINFO")?i.stdout=T(s,n):t.includes("-LICENSE")?i.stdout=g(s,"license"):t.includes("-VERSION")&&(i.stdout=g(s,"version"));return i}async function A(){let e={},t="NSIS_APP_";return Object.keys(process.env).map(n=>{n?.length&&new RegExp(`${t}[a-z0-9]+`,"gi").test(n)&&(e[n]=process.env[n]);}),e}function D(e){return e?.includes("ENOENT")&&e.match(/\bENOENT\b/)||e?.includes("EACCES")&&e.match(/\bEACCES\b/)||e?.includes("EISDIR")&&e.match(/\bEISDIR\b/)?!0:!!(e?.includes("EMFILE")&&e.match(/\bEMFILE\b/))}function F(e){let t=e.match(/(\d+) warnings?:/);return t!==null?parseInt(t[1],10):0}function N(e){return /^(0x|0X)[a-fA-F0-9]+$/.test(String(e))}function M(e){return !isNaN(e)}function k(e,t,n){return e>=t&&e<=n}async function m(e,t){let n=t.pathToMakensis?t.pathToMakensis:"makensis",s=t.pathToWine?t.pathToWine:"wine",o={json:t.json,wine:t.wine,onData:t.onData,onClose:t.onClose,onError:t.onError},i;if(require$$0.platform()!=="win32"&&t.wine===!0?(console.warn("Wine support has been degraded to an experimental feature, but it will be continued to be supported for the time being."),i=s,e.unshift(n)):i=n,e.length>1||e.includes("-CMDHELP"))return [i,e,o];if(t?.define&&Object.keys(t.define).map(r=>{t.define&&t.define[r]&&e.push(`-D${r}=${t.define[r]}`);}),t?.env){let r=await A();r&&Object.keys(r).length&&Object.keys(r).map(f=>{r&&r[f]&&e.push(`-D${f}=${r[f]}`);});}if(t?.preExecute){let r=C(t.preExecute);r.length&&e.push(...r);}if(t.noCD===!0&&e.push("-NOCD"),t.noConfig===!0&&e.push("-NOCONFIG"),t.pause===!0&&e.push("-PAUSE"),t.strict===!0&&e.push("-WX"),t.inputCharset&&O.includes(t.inputCharset)&&e.push("-INPUTCHARSET",t.inputCharset),require$$0.platform()==="win32"&&t.outputCharset&&E.includes(t.outputCharset)&&e.push("-OUTPUTCHARSET",t.outputCharset),t.ppo===!0&&e.push("-PPO"),t.safePPO===!0&&e.push("-SAFEPPO"),t.priority){let r=parseInt(String(t.priority),10);require$$0.platform()==="win32"&&M(r)&&k(r,0,5)&&e.push(`-P${t.priority}`);}if(t.verbose){let r=parseInt(String(t.verbose),10);M(r)&&k(r,0,4)&&e.push(`-V${r}`);}return t.rawArguments&&Array.isArray(t.rawArguments)&&(e=[...e,...t.rawArguments]),[i,e,o]}function g(e,t){if(t==="version"&&e.startsWith("v")&&(e=e.substring(1)),t===null)return e;let n={};return n[t]=e,n}function T(e,t){let n={sizes:{},defined_symbols:{}},s=S(e,t);if(!s?.length)return n;let o=s.filter(a=>{if(a!=="")return a}),i={},r={},f=[];return !o?.length||(o.map(a=>{if(a.startsWith("Size of ")){let u=a.split(" is ");u[0]=u[0].replace("Size of ",""),u[0]=u[0].replace(" ","_"),u[1]=u[1].slice(0,-1),i[u[0]]=u[1];}else a.startsWith("Defined symbols: ")&&(f=a.replace("Defined symbols: ","").split(","));}),n.sizes=i,!f?.length)||(f.map(a=>{let u=a.split("=");u.length>1&&u[0]!=="undefined"?(!N(u[1])&&M(Number(u[1]))&&(u[1]=parseInt(String(u[1]),10)),r[u[0]]=u[1]):r[a]=!0;}),n.defined_symbols=r),n}function v(e,t){let n=S(e,t);n.sort();let s={};return n?.length&&n.map(o=>{let i=o.substring(0,o.indexOf(" ")),r=o.substring(o.indexOf(" ")+1);["!AddIncludeDir","!AddPluginDir"].includes(i)&&(i=i.toLowerCase()),i&&(s[i]=r);}),s}function d(e,t,n,s={}){return new Promise((o,i)=>{n.wine&&(s.env=Object.freeze({WINEDEBUG:"-all",...process.env,...s.env}));let r={stdout:"",stderr:""},f=0,a="",u=require$$1.spawn(e,t,s);u.stdout?.on("data",c=>{let p=c.toString();r.stdout+=p;let l=F(p);f+=l,a===""&&(a=x(p)),typeof n.onData=="function"&&n.onData({line:p,outFile:a,hasWarning:!!l});}),u.stderr?.on("data",c=>{let p=c.toString();r.stderr+=p,typeof n.onError=="function"&&n.onError(p);}),u.on("error",c=>{console.error(c);}),u.on("close",c=>{let p=I(r,t,n),l={status:c,stdout:p.stdout||null,stderr:p.stderr||null,warnings:f};a&&(l.outFile=a),typeof n.onClose=="function"&&n.onClose(l),c===0||p.stderr&&!D(p.stderr)?o(l):i(l.stderr);});})}function C(e){let t=[];return typeof e=="string"?e.trim().includes(`
`)?e.trim().split(`
`).map(s=>{s.trim().length&&t.push(`-X${s}`);}):t.push(`-X${e}`):e.map(n=>{n.trim().length&&t.push(`-X${n}`);}),t}function S(e,t={}){let n=require$$0.platform()==="win32"||t.wine===!0?`\r
`:`
`;return e.split(n)}async function j(e="",t={},n={}){let s={...t,verbose:0},[o,i,r]=await m(["-CMDHELP"],s);return e?.length&&typeof e=="string"&&i.push(e),d(o,i,r,n)}async function H(e,t={},n={}){let[s,o,i]=await m([],t);if(e&&(s==="wine"&&o.push("--"),o.push(e)),t?.postExecute){let r=C(t.postExecute);r.length&&o.push(...r);}return d(s,o,i,n)}async function w(e={},t={}){let n={...e,verbose:0},[s,o,i]=await m(["-HDRINFO"],n);return d(s,o,i,t)}async function L(e={},t={}){let[n,s,o]=await m(["-LICENSE"],e);return d(n,s,o,t)}async function U(e={}){let t={...e,json:!0};function n(o){return e.json===!0?g(o.stdout.defined_symbols.NSISDIR,"nsisdir"):o.stdout.defined_symbols.NSISDIR}let s=await w(t);return n(s)}async function R(e={},t={}){let n={...e,verbose:0},[s,o,i]=await m(["-VERSION"],n);return d(s,o,i,t)}

exports.commandHelp = j;
exports.compile = H;
exports.headerInfo = w;
exports.license = L;
exports.nsisDir = U;
exports.version = R;
//# sourceMappingURL=makensis-0247f178.js.map
