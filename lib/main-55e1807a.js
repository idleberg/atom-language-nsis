        ...
        return __generator$2(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-fe171566.js'); }).then(function (n) { return n.index; })];
                case 1:
...
function openURL(nsisCommand) {
    return __awaiter$2(this, void 0, void 0, function () {
        ...
        return __generator$2(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-a663ec18.js'); }).then(function (n) { return n.index; })];
                case 1:
                    open = (_a.sent())["default"];
                    open("https://idleberg.github.io/NSIS.docset/Contents/Resources/Documents/html/Reference/".concat(nsisCommand, ".html?utm_source=atom&utm_content=reference"));
                    return [2 /*return*/];
            }
        });
    });
        ...
        return __generator$2(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-97ce3ca2.js'); }).then(function (n) { return n.index; })];
                case 2:
...
function compile(strictMode) {
    return __awaiter$2(this, void 0, void 0, function () {
        var editor, script, scope, isHeaderFile, processHeaders, notification_1, error_1, _a, clearConsole, getMakensisPath, getSpawnEnv, isLoadedAndActive, NSIS, _b, compilerOutputHandler, compilerErrorHandler, compilerExitHandler_1, verbosity, _c, _d, _e;
        var _f;
        var _this = this;
        return __generator$2(this, function (_g) {
            switch (_g.label) {
                ...
                case 7:
                    _g.sent();
                    _g.label = 8;
                case 8: return [4 /*yield*/, Promise.resolve().then(function () { return require('./makensis-73eb3104.js'); })];
                case 9:
                    NSIS = _g.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./handlers-7944bd9e.js'); })];
                case 10:
                    _b = _g.sent(), compilerOutputHandler = _b.compilerOutputHandler, compilerErrorHandler = _b.compilerErrorHandler, compilerExitHandler_1 = _b.compilerExitHandler;
                    NSIS.events.on('stdout', compilerOutputHandler);
                    NSIS.events.on('stderr', compilerErrorHandler);
                    NSIS.events.once('exit', function (data) { return __awaiter$2(_this, void 0, void 0, function () { return __generator$2(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, compilerExitHandler_1(data)];
                ...
                case 11:
                    _e = _e.concat([(_f.pathToMakensis = _g.sent(),
                            _f.rawArguments = Config.get('compilerOptions.customArguments'),
                            _f.strict = strictMode || Config.get('compilerOptions.strictMode'),
                            _f.verbose = verbosity.inRange(0, 4) ? verbosity : undefined,
                            _f)]);
...
function showVersion() {
    return __awaiter$2(this, void 0, void 0, function () {
        var _a, clearConsole, getMakensisPath, getSpawnEnv, isLoadedAndActive, pathToMakensis, NSIS, versionHandler, _b, _c, _d;
        return __generator$2(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./makensis-73eb3104.js'); })];
                case 5:
                    NSIS = _e.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./handlers-7944bd9e.js'); })];
                case 6:
                    versionHandler = (_e.sent()).versionHandler;
                    NSIS.events.once('stdout', function (data) { return versionHandler(data, pathToMakensis); });
                    _c = (_b = NSIS).version;
                    _d = [{
...
function showCompilerFlags() {
    return __awaiter$2(this, void 0, void 0, function () {
        var _a, clearConsole, getMakensisPath, getSpawnEnv, isLoadedAndActive, NSIS, flagsHandler, _b, _c, _d;
        var _e;
        return __generator$2(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./handlers-7944bd9e.js'); })];
                case 5:
                    flagsHandler = (_f.sent()).flagsHandler;
...
function showHelp(selectListView) {
    return __awaiter$2(this, void 0, void 0, function () {
        ...
        return __generator$2(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./makensis-73eb3104.js'); })];
                case 1:
                    NSIS = _f.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return util; })];
                case 2:
...
function convertNLF(editor) {
    return __awaiter$2(this, void 0, void 0, function () {
        ...
        return __generator$2(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./index-e1c6a73b.js'); })];
                case 1:
                    NLF = _a.sent();
                    try {
...
var commandReference = {
    init: function () {
        return __awaiter$2(this, void 0, void 0, function () {
            ...
            return __generator$2(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./select-list-view-1199bb86.js'); }).then(function (n) { return n.selectListView; })];
                    case 1:
                                ...
                                return __generator$2(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, Promise.resolve().then(function () { return require('./build-1ec6724c.js'); })];
                                        case 2:
                                ...
                                return __generator$2(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, Promise.resolve().then(function () { return require('./runner-d7a6272c.js'); })];
                                        case 2:
...
exports.main = main;
exports.util = util;
//# sourceMappingURL=main-55e1807a.js.map
