...
function saveBuildFile(options) {
    return main.__awaiter(this, void 0, void 0, function () {
        ...
        return main.__generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./main-057e63ed.js'); }).then(function (n) { return n.util; })];
                case 1:
...
//# sourceMappingURL=build-2c97a3e8.js.map
