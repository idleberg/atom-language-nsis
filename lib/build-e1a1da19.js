        ...
        return main.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./main-50c07da4.js'); }).then(function (n) { return n.util; })];
                case 1:
                    ...
                    scriptFile = require$$1.basename(currentFilePath);
                    currentPath = require$$1.dirname(currentFilePath);
                    buildFileSyntax = String(main.Config.get('buildFileSyntax'));
                    buildFileName = ".atom-build.".concat(buildFileSyntax.toLowerCase());
                    buildFilePath = require$$1.join(currentPath, buildFileName);
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./main-50c07da4.js'); }).then(function (n) { return n.util; })];
                case 2:
        ...
        return main.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    _b = require$$1.resolve(wineProviderPath, 'lib', 'makensis-wine.sh');
                    return [3 /*break*/, 5];
                ...
                case 8:
                    ...
                    return [4 /*yield*/, require$$0.promises.writeFile(options.filePath, stringifier, 'utf-8')];
                case 9:
                    _d.sent();
                    return [3 /*break*/, 11];
                case 10:
...
//# sourceMappingURL=build-e1a1da19.js.map
