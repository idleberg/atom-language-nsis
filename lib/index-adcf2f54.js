...
var main$1 = require('./main-800e620e.js');
var require$$0 = require('path');
var require$$1 = require('child_process');
var index$2 = require('./index-1fd3b9e3.js');
...
var process$1 = main$1.commonjsGlobal.process;
...
var sync = execa$1.exports.sync = (file, args, options) => {
	const parsed = handleArguments(file, args, options);
	const command = joinCommand(file, args);
	const escapedCommand = getEscapedCommand(file, args);
...
var command = execa$1.exports.command = (command, options) => {
	const [file, ...args] = parseCommand(command);
	return execa(file, args, options);
};

var commandSync = execa$1.exports.commandSync = (command, options) => {
	const [file, ...args] = parseCommand(command);
	return execa.sync(file, args, options);
};

var node = execa$1.exports.node = (scriptPath, args, options = {}) => {
...
var execaExports = execa$1.exports;
var index = /*@__PURE__*/main$1.getDefaultExportFromCjs(execaExports);
...
//# sourceMappingURL=index-adcf2f54.js.map
