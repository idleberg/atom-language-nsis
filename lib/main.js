...
module.exports = NsisCore = {
  ...
  activate: function(state) {
    ...
    Runner = __webpack_require__(140);
...
var Util, meta, readManifestSync;

({readManifestSync} = __webpack_require__(2));
...
var Makensis, meta, readManifestSync;
...
module.exports = Makensis = {
  compile: function(strictMode, consolePanel) {
    ...
    editor = atom.workspace.getActiveTextEditor();
    if (editor == null) {
      return atom.notifications.addWarning(`**${meta.name}**: No active editor`, {
        dismissable: false
      });
    }
    ...
    return getMakensisPath(function(pathToMakensis) {
      ...
      return version({
        ...
        if (getConfig("compilerOutput") === "Console") {
          ...
          atom.notifications.addInfo(`**${meta.name}**`, {
...
const Hindi = __webpack_require__(97);
const Hungarian = __webpack_require__(98);
const Icelandic = __webpack_require__(99);
const Indonesian = __webpack_require__(100);
const Irish = __webpack_require__(101);
const Italian = __webpack_require__(102);
const Japanese = __webpack_require__(103);
const Korean = __webpack_require__(104);
const Kurdish = __webpack_require__(105);
const Latvian = __webpack_require__(106);
const Lithuanian = __webpack_require__(107);
const Luxembourgish = __webpack_require__(108);
const Macedonian = __webpack_require__(109);
const Malay = __webpack_require__(110);
const Mongolian = __webpack_require__(111);
const Norwegian = __webpack_require__(112);
const NorwegianNynorsk = __webpack_require__(113);
const Pashto = __webpack_require__(114);
const Polish = __webpack_require__(115);
const Portuguese = __webpack_require__(116);
const PortugueseBR = __webpack_require__(117);
const Romanian = __webpack_require__(118);
const Russian = __webpack_require__(119);
const ScotsGaelic = __webpack_require__(120);
const Serbian = __webpack_require__(121);
const SerbianLatin = __webpack_require__(122);
const SimpChinese = __webpack_require__(123);
const Slovak = __webpack_require__(124);
const Slovenian = __webpack_require__(125);
const Spanish = __webpack_require__(126);
const SpanishInternational = __webpack_require__(127);
const Swedish = __webpack_require__(128);
const Tatar = __webpack_require__(129);
const Thai = __webpack_require__(130);
const TradChinese = __webpack_require__(131);
const Turkish = __webpack_require__(132);
const Ukrainian = __webpack_require__(133);
const Uzbek = __webpack_require__(134);
const Vietnamese = __webpack_require__(135);
const Welsh = __webpack_require__(136);
...
Object.defineProperty(exports, "__esModule", { value: true });
var dictionary_js_1 = __webpack_require__(139);
/**
...
var Runner, meta, readManifestSync;
...
module.exports = Runner = {
      ...
      return atom.confirm({
        ...
        buttons: {
          "Use makensis": function() {
            atom.notifications.addSuccess(`**${meta.name}**: Set \`runner.scopes.nsis\` to 'makensis -'`, {
              dismissable: false
            });
            return atom.config.set("runner.scopes.nsis", "makensis -");
          },
          "Cancel": function() {
            atom.notifications.addWarning(`**${meta.name}**: Cancelled setting default runner`, {
              dismissable: false
            });
          }
        }
  ...
  remove: function() {
    this.check();
    if ((typeof this.runner.path !== "undefined") && (this.runner.active === true)) {
      atom.notifications.addSuccess(`**${meta.name}**: Unset \`runner.scopes.nsis\``, {
        dismissable: false
      });
  ...
  notify: function() {
    return atom.notifications.addWarning(`**${meta.name}**: [atom-runner](https://atom.io/packages/atom-runner) is not installed`, {
      dismissable: false
    });
  },
  check: function() {
